...
|---|---|---|---|
| `RaBbLE-Identity-gist.md` | `common/RaBbLE-Identity.md` | ~250 | ~3,870 |
| `RaBbLE-Collective-gist.md` | `common/RaBbLE-Collective.md` | ~250 | ~1,930 |
| `RaBbLE-Roadmap-gist.md` | `common/RaBbLE-Roadmap.md` | ~250 | ~2,746 |
| `RaBbLE-CommitStyle-gist.md` | `common/RaBbLE-CommitStyle.md` | ~150 | ~620 |
| `RaBbLE-Versioning-gist.md` | `RaBbLE-Versioning.md` | ~200 | ~1,471 |
| `RaBbLE-Palette-gist.md` | `common/RaBbLE-Palette.md` | ~150 | ~1,170 |
