...
| File | What |
|---|---|
| `RaBbLE-Ethos.md` | Consolidated ethos — anti-assistant manifesto, low entropy philosophy, curiosity-within-constraints, on memory, on forking *(incoming from Phase 2B split)* |
| `RaBbLE-Symbiosis.md` | Entity/Collective relationship — recursion as load-bearing architecture, organs not modules *(to be authored)* |

## Reading Order

1. `RaBbLE-Ethos.md` — the philosophical substrate
