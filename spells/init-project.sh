...
EPOCH=$(grep "^epoch:" "$GRIMOIRE_ROOT/registry/epochs/current.epoch.yml" 2>/dev/null | awk '{print $2}' || echo "1")
...
MANIFEST_FILE="$GRIMOIRE_ROOT/registry/manifests/${SLUG}.manifest.yml"
