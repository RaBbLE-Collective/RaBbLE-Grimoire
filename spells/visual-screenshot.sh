...
#   --out PATH        Output path (default: ~/RaBbLE-Collective/RaBbLE-BaBbLE/captures/_inbox/visual-TIMESTAMP.png)
...
OUT="$RABBLE_ROOT/RaBbLE-BaBbLE/captures/_inbox/visual-$STAMP.png"
DELAY="2"
