...
- **README CDN URL is worse than a 404** — `cdn.joinrabble.world` fails DNS entirely; the real host is `aether.joinrabble.world`. → deferred with the Aether version/CDN item.
