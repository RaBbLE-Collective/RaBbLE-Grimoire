...
RaBbLE is not versioned. It is evolutionary. Progression is retrospective — thresholds
named after crossing, not before. Full versioning spec: `../../versioning.md`

| Tier | Meaning |
|------|---------|
| **Event** | A commit — the atomic unit. |
| **Episode** | A collection of Events with a dominant theme. Narrative arc. |
| **Echo** | A stable, returnable state. Tagged. Reproducible. |
| **Evolution** | A significant shift — architecture, identity, or protocol. |
| **Epoch** | The broadest era. Named retrospectively when a threshold is crossed. |

Version string: `v{Epoch}.{Evolution}.{Echo}.{Episode}.{Event}`
Example: `v0.0.0.1.23` = Epoch 0, Evolution 0, Echo 0, Episode 1, Event 23

The E also echoes through the entity's core vocabulary: Entropy, Expression,
Emergence, Engine, Ethos.
...
| 2026-04-16 | The Three Es added — epochs as evolutionary axis, not release targets | Versioning model established |
| 2026-04-23 | Distilled to manifesto + identity + lore; removed redundancy | Low Entropy pass |
| 2026-04-30 | Three Es expanded to Five Es (Event, Episode, Echo, Evolution, Epoch); consolidated to RaBbLE-Grimoire | Versioning granularity; single source of truth |
