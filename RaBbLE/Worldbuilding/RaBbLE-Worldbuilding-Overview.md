...
Synthwave/neotokyo/outrun as expression, not decoration. Boot as theater. The palette as character. The OS as the entity's body.

## Contents

| File | What |
|---|---|
| `RaBbLE-Aesthetic.md` | Visual world doc — the synthwave framing, boot sequence as theater, palette as character expression *(incoming from Identity.md "The Artistic Dimension" + to be expanded)* |
